...
// Magazin** copiazaInMatrice(Magazin* vector, int nrMagazine, int* nrLinii, int prag) { // ?
//     int dim = 0;
//     for (int i = 0; i < nrMagazine; i++)
//     {
//         if (vector[i].nrAngajati >= prag)
//         {
//             dim++;
//         }
//     }
...
//     Magazin** matrice = (Magazin**)malloc(dim * sizeof(Magazin));
//     for (int i = 0; i < dim; i++)
//     {
//         matrice[i] = (Magazin*)malloc(nrMagazine * sizeof(Magazin));
//     }
